...
func (t *HTTPGetTool) Desc() string { return "HTTP GET a URL. Inputs: url (string)" }
func (t *HTTPGetTool) Schema() Schema { return Schema{Name: t.Name(), Desc: t.Desc(), Inputs: map[string]string{"url":"string"}} }
